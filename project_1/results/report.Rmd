...
This project is conducted to help UMD better offer their amazing services to people in need by considering both "macro" and "micro" aspects. We first analysed the trend of the people coming for help, including the needs for different services and the relationships between different needs. Furthermore, some specific analysis with respect to each family/person (take some as examples) was also performed to give personal care for each coming family/person. In the conclustion part, we offered some suggestions to UMD and hoped it would be helpful for their future operations.
...
We did the same thing for clothing items as for food pounds. It showed that the change of clothing items was roughly the same as that of food pounds which increased before 2010, fluctuated between 2010-2015 and then decreased after 2015. But the intensity is was not as high as that of food pounds. It supported my opinion brought up before. 
...
From the scatter plots above, we could see that foods and clothes have most observations, which indicated that these two are the most needed. It's consistent with the commen sense that they were for basic life.
...
They both have come since more than 10 years ago. It suggests that they have been going through a hard time for really long and they may need further help.
...
3. The relationships between number of people served and food pounds, clothing items and the average amounts that per person served per visit needs. 

4. Specific analysis for some families/people.


Therefore, my advice is given below according to each analysis of the questions.


1. UMD should continue serving foods and clothes for homeless people since these two are mostly needed. The trend shows that the needs of food seem to be decreasing a little but the needs of clothes seem to be slightly increasing. Therefore, maybe less food and more clothes are needed in a short time.
...
+ [2] The average food that they served everyday was ~400 pounds from 2005 till now and ~570 pounds from 2015 till now. 
+ [3] The average clothing items that they served everyday was ~180 from 2005 till now and ~200 from 2015 till now. 
